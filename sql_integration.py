...
def insert_data_tosql(data_path):
    ...
    for index, row in df.iterrows():
        ...
        INSERT INTO main (
            ...
            food_covered, food_provided, transportation_provided, study_levels, language_suitability, probability
        ) VALUES (
        ...
        values = (
            ...
            row['study_levels'], row['language_suitability'] ,row['probability']
        )
