...
def second_stage(urls_path, data_path, suitable_languages):
    ...
    def language_suitability(df, languages_df, suitable_languages):
        ...
        return df['language_suitability']
    ...
    df['language_suitability']  = language_suitability(df, languages_df, suitable_languages)
